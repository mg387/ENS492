...
// Fixed per leg, if not defined 0
...
#ifdef QUADMODE
//#define ADD_GAITS
#define PYPOSE_GAIT_SPEED 25 //98
...
PHOENIXGAIT APG[] = {
//  {PYPOSE_GAIT_SPEED, 20, 5, 2, 2, 15, 3, 2500, 3600 / 20, 30, false,{11, 16, 1, 6}},  // test 20     works at double range
  {PYPOSE_GAIT_SPEED, 20, 5, 2, 4, 15, 3, 2500, 3600 / 20, 30, false,{11, 16, 1, 6}},  // test 20            works at double range

//  {PYPOSE_GAIT_SPEED,  4, 2, 1, 2,  2, 2,    0,         0,  0, true,  {3, 1, 1,  3}},  // Amble 
  {PYPOSE_GAIT_SPEED,  4, 2, 1, 4,  2, 2,    0,         0,  0, true,  {3, 1, 1,  3}},  // Amble  
  
//  {PYPOSE_GAIT_SPEED,  8, 2, 1, 2,  6, 1,    0,         0,  0, true,  {7, 1, 3,  5}},   // ripple
  {PYPOSE_GAIT_SPEED,  8, 2, 1, 4,  6, 1,    0,         0,  0, true,  {7, 1, 3,  5}},   // ripple
  
//x {PYPOSE_GAIT_SPEED, 12, 2, 1, 2, 10, 1,    0,         0,  0, true,  {7, 1, 4, 10}},   // ripple  
//x  {PYPOSE_GAIT_SPEED,  6, 3, 2, 4,  3, 2,    0,         0,  0, true,  {1, 4, 4,  1}}  // Smooth Amble 
};
...
//    {DEFAULT_GAIT_SPEED, 20, 5, 2, 2, 15, 3, 2500, 3600 / 20, 30, false, {11, 16, 1, 6} GAITNAME(s_szGN3)}        // test 20
//};    

//PHOENIXGAIT APG[] = {
//  {DEFAULT_GAIT_SPEED, 20, 5, 2, 2, 15, 3, 2500, 3600 / 20, 90, false, {11, 16, 1, 6} GAITNAME(s_szGN1)},          // test 20
//};
